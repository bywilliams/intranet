                ...
                <div class="card ">
                    ...
                    <div class="card-body p-4 text-white" style="background-color: #fff;">
                       <div class="row"<?php if($_SESSION["nivel"] == 3){echo 'style="justify-content: end"';}?>>
                        ...
                        <div class="col-md-1" style="display: flex; font-size: 0.8rem; color: #000;"><i class="bi bi-check2-square text-success" style="font-size: 1rem;"></i>Ticar</div>
                        <div class="col-md-3"  style="display: flex; font-size: 0.8rem; justify-content: center; color: #000;"><i class="bi bi-check text-success" style="font-size: 1rem;"></i>Atualizar no Sistema</div>
                        <?php
                        if ($_SESSION["nivel"] != 3) {
                            ?>
                            <div class="col-md-3"  style="display: flex; font-size: 0.8rem; color: #000;"><i class="bi bi-lock-fill text-danger" style="font-size: 1rem;"></i>Designada pelo ADM</div>   
                            <?php
                        }
                        ?>
                            ...
                            <tbody>
                                ...
                                if ($result_tarefas->num_rows > 0) {
                                   while ($rowTarefas = $result_tarefas->fetch_assoc()) {
                                        ...
                                        if (empty($status_task) && $dia_atual == $dia_expired) {
                                ...
                                <tr class="fw-normal">
                                    ...
                                    <td class="align-middle">
                                        <span id="span_<?=$t;?>" style="<?php if(!empty($status_task)){echo $check_mark;}?>"><?=$name_task?></span>
                                    </td>
                                    <td class="align-middle">
                                        <h6 class="mb-0"><span
                                    ...
                                    <td class="align-middle">
                                        ...
                                        <a href="#!" title="Feito" id="feito_<?=$t;?>"
                                            onclick="check(<?=$t?>);"><i class="bi bi-check2-square text-success" style="font-size: 1.5rem;"></i></a>
                                      
                                        <a href="act_users/task_act.php?action_atualiza=1&task_id=<?=$task_id?>" title="Feito" id="feito_<?=$t;?>"
                                            onclick="check(<?=$t?>);"><i class="bi bi-check text-success" style="font-size: 1.5rem;"></i></a>
